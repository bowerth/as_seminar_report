...
```{r qplotex1, message=FALSE, fig.height=6.5, fig.width=10}
...
```{r qplotex2, message=FALSE, fig.height=6.5, fig.width=10}
...
```{r ggplotlayer, message=FALSE, fig.height=5, fig.width=10}
ggplot() +
...
```{r ggthemescustomprep, message=FALSE, echo=FALSE}
pal.crN <- c('#95B3D7','#F79646','#8064A2','#4BACC6','#9BBB59','#C0504D','#DA9694','#C4D79B','#B1A0C7','#4F81BD','#92CDDC','#FABF8F')
```

```{r ggthemescustom, message=FALSE, warning=FALSE, echo=TRUE, fig.height=5}
